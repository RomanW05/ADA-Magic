...
from orderedCommands import sendSimpleTransactionWithRoyalties
import logging
...
try:
    ...
    walletRoyalty = sys.argv[6]
    amountToSendRoyalty = sys.argv[7]

    userAddress = loadAddress(homePath, user)
    sendSimpleTransactionWithRoyalties(homePath, mainTest, user, userAddress, amountToSend, walletReveiver, walletRoyalty, amountToSendRoyalty, platformAddress, platformFee)
except:
