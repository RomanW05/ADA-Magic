...
(function($) {
    ...
    var rtl_mode = 'off'; // on - for enable RTL, off - for deactive RTL
     ...
     function saveImage(ids, action){
          var url = 'https://adamagic.io/store_hearts/';
          url += ids;
          url += '/';
          url += action;
     ...
     function menu_arrow() {
         ...
         jQuery(".item_info_like").on("click", function() {
             var iteration = $(this).data('iteration') || 1;
             var ids = $(this).find("id");
             ids = ids['prevObject'][0]['id'];
             ids = String(ids);
    ...
    function image_preview(){
     ...
     jQuery(document).ready(function() {
        ...
        $('#get_file').click(function(){
         ...
         $('#get_file_collection').click(function(){
            $('#upload_file_collection').click();
         });


        $('#get_file_a0').click(function(){
            $('#get_file_b0').click();
         });
        $('#get_file_a1').click(function(){
            $('#get_file_b1').click();
         });
        $('#get_file_a2').click(function(){
            $('#get_file_b2').click();
         });
        $('#get_file_a3').click(function(){
            $('#get_file_b3').click();
         });
        $('#get_file_a4').click(function(){
            $('#get_file_b4').click();
         });
        $('#get_file_a5').click(function(){
            $('#get_file_b5').click();
         });
        $('#get_file_a6').click(function(){
            $('#get_file_b6').click();
         });
        $('#get_file_a7').click(function(){
            $('#get_file_b7').click();
         });
        $('#get_file_a8').click(function(){
            $('#get_file_b8').click();
         });
        $('#get_file_a9').click(function(){
            $('#get_file_b9').click();
         });
        $('#get_file_a10').click(function(){
            $('#get_file_b10').click();
         });
        $('#thumbnail_a').click(function(){
            $('#thumbnail_b').click();
         });
        ...
        $('#thumbnail_b').change(function(){
            var file = $(this).val();
            var filename = file.replace(/^.*\\/, "");
            $('#file_name_thumb').text(filename);
         });

        $('#get_file_b0').change(function(){
            const inputElement = document.getElementById("get_file_b0");
            inputElement.addEventListener("change", handleFileSelect, false);
            function handleFileSelect(evt) {
                const fileList = evt.target.files; /* now you can work with the file list */
                var names = '';
                for (let i = 0, numFiles = fileList.length; i < numFiles; i++) {
                  names = String(names) + ', ' + fileList[i].name;
                }

                $('#file_name_layer0').text(names);

            }
            // handleFiles();
         });
        $('#get_file_b1').change(function(){
            const inputElement = document.getElementById("get_file_b1");
            ...
            function handleFiles() {
                ...
                $('#file_name_layer1').text(names);

            }
            handleFiles();
         });
        $('#get_file_b2').change(function(){
            const inputElement = document.getElementById("get_file_b2");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer2').text(names);

            }
            handleFiles();
         });
        $('#get_file_b3').change(function(){
            const inputElement = document.getElementById("get_file_b3");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer3').text(names);

            }
            handleFiles();
         });
        $('#get_file_b4').change(function(){
            const inputElement = document.getElementById("get_file_b4");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer4').text(names);

            }
            handleFiles();
         });
        $('#get_file_b5').change(function(){
            const inputElement = document.getElementById("get_file_b5");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer5').text(names);

            }
            handleFiles();
         });
        $('#get_file_b6').change(function(){
            const inputElement = document.getElementById("get_file_b6");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer6').text(names);

            }
            handleFiles();
         });
        $('#get_file_b7').change(function(){
            const inputElement = document.getElementById("get_file_b7");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer7').text(names);

            }
            handleFiles();
         });
        $('#get_file_b8').change(function(){
            const inputElement = document.getElementById("get_file_b8");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer8').text(names);

            }
            handleFiles();
         });
        $('#get_file_b9').change(function(){
            const inputElement = document.getElementById("get_file_b9");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
                ...
                $('#file_name_layer9').text(names);

            }
            handleFiles();
         });
        $('#get_file_b10').change(function(){
            const inputElement = document.getElementById("get_file_b10");
            inputElement.addEventListener("change", handleFiles, false);
            function handleFiles() {
                const fileList = this.files; /* now you can work with the file list */
                var names = '';
        ...
        $('#upload_file').change(function(){
         ...
         $('#upload_file_collection').change(function(){
            var file = $(this).val();
            var filename = file.replace(/^.*\\/, "");
            $('#file_name_collection').text(filename);
         });
