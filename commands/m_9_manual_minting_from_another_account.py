...
def simple_mint(user, userAddress, txhash, txin, funds, policyID, policyName, NFTName, NFTAmount, NFTMint, metadata_path, invalid_herafter):
    ...
    ' --signing-key-file ' + homePath + 'keys/ADA_Magic_io/ADA_Magic_io.skey' + \
    ' --signing-key-file ' + homePath + 'keys/astralsisters/' + policyName + '.skey ' + \
    mainTest + \
...
metadata_path = f'/home/yop/Downloads/cardano-node1.30.0/keys/astralsisters/.json'
