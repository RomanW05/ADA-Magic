...
royalties_wallet = sys.argv[10]
royalties_perc = sys.argv[11]
platform_fees = '2000000'
...
try:
    ...
    os.rmdir(homePath + 'keys/' + project_name)
    time.sleep(0.1)
    ...
    # Set royalties wallet
    with open(f'/home/yop/Downloads/cardano/vending_machine/{project_name}/royalties_wallet.txt', 'w') as text:
        text.write(royalties_wallet)

    # Set royalties percentage
    with open(f'/home/yop/Downloads/cardano/vending_machine/{project_name}/royalties_perc.txt', 'w') as text:
        text.write(royalties_perc)

    # Set platform fees
    with open(f'/home/yop/Downloads/cardano/vending_machine/{project_name}/platform_fees.txt', 'w') as text:
        text.write(platform_fees)
    ...
    # os.system(f'python3 /home/yop/Downloads/cardano-node1.30.0/commands/spltCommands/a_33_create_layers_structure_generative_art.py {project_name} {nfts_total}')
