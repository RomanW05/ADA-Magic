...
try:
    ...
    ada_sent = sys.argv[11]
    nft_address = sys.argv[12]
    tx_in = sys.argv[13]
    tx_hash = sys.argv[14]

    with open(f'/home/yop/Downloads/cardano/single_nfts/{user}/{NFTName}/policy_id.txt', 'r') as text:
        policy_id = text.read()

    send_single_nft(homePath, mainTest, user, walletReceiver, NFTName, policyName, ADAMagic_fee, money_reminder, ADAMagic_wallet, nft_price, nft_utxo, nft_txin, ada_sent, nft_address, policy_id, tx_in, tx_hash)
except:
